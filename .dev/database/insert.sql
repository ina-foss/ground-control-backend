...
INSERT INTO task (name, instruction, data, projectid) VALUES 
('Task 1', 'This is task 1', '{"key": "value"}', 1),
('Task 2', 'This is task 2', '{"key": "value"}', 2);

-- Insert data into the prediction table
INSERT INTO prediction (model_name, model_version, result, score, taskId, projectid) VALUES 
('Model 1', '1.0', '{"result": "value"}', 0.9, 1, 1),
('Model 2', '1.0', '{"result": "value"}', 0.8, 2, 2);

-- Insert data into the annotation table
INSERT INTO annotation (created_by, result, taskid, projectid) VALUES 
(1, '{"result": "value"}', 1, 1),
(2, '{"result": "value"}', 1, 2);

-- Insert data into the user_task table
INSERT INTO user_task (userid, taskid, task_status) VALUES 
(1, 1, "in progress"),
(2, 1, "validated");
