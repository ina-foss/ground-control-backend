...
def upgrade() -> None:
    ...
    op.create_table('project',
                    ...
                    sa.ForeignKeyConstraint(['created_by'], [USER_ID_REFERENCE], name='project_created_by_fkey'),
                    sa.PrimaryKeyConstraint('id', name='project_pkey'),
                    postgresql_ignore_search_path=False
                    )
    op.create_table('task',
                    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('task_id_seq'::regclass)"),
                              autoincrement=True, nullable=False),
    ...
    op.create_table('annotation',
                    ...
                    sa.Column('project_id', sa.INTEGER(), autoincrement=False, nullable=True),
                    sa.Column('status', sa.TEXT(), server_default=sa.text("'in progress'::text"), autoincrement=False,
                              nullable=True),
                    ...
                    sa.ForeignKeyConstraint(['user_id'], [USER_ID_REFERENCE], name='annotation_user_id_fkey'),
    ...
    op.create_table('user_task',
                    ...
                    sa.ForeignKeyConstraint(['user_id'], [USER_ID_REFERENCE], name='user_task_user_id_fkey'),
